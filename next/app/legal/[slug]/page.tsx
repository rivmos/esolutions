...
const Page = async ({ params }: { params: { slug: string } }) => {
  const data = await prisma?.legal.findFirst({
    where: {
      slug: params.slug
    }
  });
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="text-left space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="text-center !mt-12">
              <Link href="/" className="bg-blue-600 text-white py-2 px-4 md:px-6 rounded-md transition hover:bg-blue-700 whitespace-nowrap">
                  Back to home
              </Link>
            </div>
          </div>
