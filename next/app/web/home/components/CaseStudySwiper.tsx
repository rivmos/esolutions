                    ...
                    return (
                        <SwiperSlide key={index} className='my-4'>
                            <div className='flex flex-col select-none bg-white rounded-md border-[1px] h-full py-6'>
                                <h6 className='text-left font-semibold px-4 text-lg'>{item.title}</h6>
                                <div className='overflow-y-auto mb-2 px-4 text-sm'>{shortenText(item?.description as string)}</div>
