                ...
                <div className=" flex flex-wrap items-center">
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-white dark:bg-gray-900">
                      ...
                      <h2 className="text-sm text-gray-700 dark:text-gray-400">Inquiries Resolved</h2>
                    </div>
                  </div>
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-white dark:bg-gray-900">
                      ...
                      <h2 className="text-sm text-gray-700 dark:text-gray-400">Satisfied Clients</h2>
                    </div>
                  </div>
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-white dark:bg-gray-900">
                      ...
                      <h2 className="text-sm text-gray-700 dark:text-gray-400">Professional Team Members</h2>
                    </div>
                  </div>
                  <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                    <div className="p-6 bg-white dark:bg-gray-900">
                      ...
                      <h2 className="text-sm text-gray-700 dark:text-gray-400">Projects Completed On Time</h2>
                    </div>
                  </div>
                </div>
              </div>
