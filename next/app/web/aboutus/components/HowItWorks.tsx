      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg border-2 py-16">
            <FaCalendarAlt className="text-blue-600 text-3xl md:text-4xl lg:text-5xl mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg border-2 py-16">
            <FaChartLine className="text-blue-600 text-3xl md:text-4xl lg:text-5xl mx-auto mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg border-2 py-16">
            <FaClipboardCheck className="text-blue-600 text-3xl md:text-4xl lg:text-5xl mx-auto mb-4" />
