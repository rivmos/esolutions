...
const Page = () => {
  ...
  return (
    <div>
      <Banner bannerImage='/img/banner/digital-marketing-bg.png' title='Digital Marketing & Analytics' isShort />
      ...
      <Features image='/img/services/analytics.png' imageAlt='Image depicting digital marketing analytics' features={features}/>
    </div>
  )
}
