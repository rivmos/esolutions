...
const Page = () => {
  ...
  return (
    <div>
      ...
      <Features image='https://res.cloudinary.com/dbgcgbsgh/image/upload/v1723403741/wvrjo8x1wdrr6rplxj7n.jpg' imageAlt='Image depicting mobile application development' features={features} slugToExclude='mobile-developement'/>
    </div>
  )
}
