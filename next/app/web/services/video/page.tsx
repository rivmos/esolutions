...
const Page = () => {
  ...
  const board = {
    ...
    image: "/img/services/video-animation.png",
    cards: [
      {
  ...
  return (
    <div>
      <Banner bannerImage='/img/banner/video-animation-bg.png' title='Video & Animation' isShort />
      ...
      <Features image='/img/services/video-production.png' imageAlt='Image depicting video production process' features={features}/>
    </div>
  )
}
